'''
Connector : It's a connector between azure video indexer and python 
'''
# print("VIDEO INDEXER START")
import os
...
class VideoIndexerService:
    def __init__(self):
        ...
        self.vi_name = os.getenv("AZURE_VI_NAME","brand-guardian-yt-group")
    ...
    def download_youtube_video(self, url, output_path = "temp_video.mp4"):
        ...
        try:
            ...
            raise Exception(f"Youtuve Video Download Failed : {str(e)}")
    ...
    def upload_video(self,video_path,video_name):
        ...
        logger.info(
            f"Upload Response: {response.status_code} "
            f"{response.text}"
        )
    ...
    def extract_data(self, vi_json):
        ...
        ocr_lines = []   ## optical character recognition test 
        for v in vi_json.get("videos",[]):
