...
def index_video_node(state:VideoAuditState) -> Dict[str,Any]:
    ...
    try:
        ...
        # wait
        raw_insights = vi_service.wait_for_processing(azure_video_id) ## this line prevent code from moving forward unless and until azure has done its task
        #extract
...
def audio_content_node(state: VideoAuditState) -> Dict[str, Any]:
    ...
    system_prompt = f"""
        ...
        2. Identity ANY violations of the rules.
